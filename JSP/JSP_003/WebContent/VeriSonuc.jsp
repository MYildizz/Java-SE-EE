...
<body>
	...
	<!-- 
	<jsp:setProperty name="kisi" property="adi"/>
	<jsp:setProperty name="kisi" property="soyadi"/>
	<jsp:setProperty name="kisi" property="okul"/>
	<jsp:setProperty name="kisi" property="ulke"/>
	<jsp:setProperty name="kisi" property="telefon"/>
	<jsp:setProperty name="kisi" property="cinsiyet"/>
	<jsp:setProperty name="kisi" property="meslek"/>
	<jsp:setProperty name="kisi" property="uyruk"/>
	 -->
	 
	 <jsp:setProperty name="kisi" property="*"/>
